...
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_komentar WHERE id_komentar=$id_komentar " );
    return mysqli_affected_rows($koneksi);
}
function hapuskomentarptn($id_komentar)
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_kometarptn WHERE id_komentar=$id_komentar " );
    return mysqli_affected_rows($koneksi);
}
...
function caridatakomentar($keyword)
{
    $query = "SELECT * FROM tb_kometarptn WHERE nama LIKE  '%$keyword%' or id LIKE '%$keyword%' or komentar LIKE '%$keyword%' ";
    return querydataKontak($query);
}
function caridatakomentarpts($keyword)
{
    $query = "SELECT * FROM tb_komentar WHERE nama LIKE  '%$keyword%' or id LIKE '%$keyword%' or komentar LIKE '%$keyword%' ";
    return querydataKontak($query);
}
function caridatauserweb($keyword)
{
    $query = "SELECT * FROM tb_datauser WHERE nama LIKE  '%$keyword%' or id_profil LIKE '%$keyword%' or kota LIKE '%$keyword%' ";
    return querydataKontak($query);
}
...
function tambahkomentar($data,$id,$id_link,$nama,$tanggal,$fotoprofil){
    global $koneksi;
    $komentar=htmlspecialchars($data["komentar"]);
    
    $query ="INSERT INTO tb_komentar VALUES('','$id','$id_link','$komentar','$nama','$tanggal','$fotoprofil')";
    mysqli_query($koneksi,$query);
    return mysqli_affected_rows($koneksi);

}

function tambahkomentarptn($datas,$id,$id_link,$nama,$tanggal,$fotoprofil){
    global $koneksi;
    $komentarptn=htmlspecialchars($datas["komentar"]);
    
    $queryptn ="INSERT INTO tb_kometarptn VALUES('','$id','$id_link','$komentarptn','$nama','$tanggal','$fotoprofil')";
    mysqli_query($koneksi,$queryptn);
    return mysqli_affected_rows($koneksi);
...
function hapuskomentarptnadmin($id_komentar)
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_kometarptn WHERE id_komentar=$id_komentar" );
    return mysqli_affected_rows($koneksi);
}
function hapuskomentarptsadmin($id_komentar)
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_komentar WHERE id_komentar=$id_komentar" );
    return mysqli_affected_rows($koneksi);
}
function hapusdatauser($id_profil)
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_datauser WHERE id_profil=$id_profil" );
    return mysqli_affected_rows($koneksi);
}
?>
