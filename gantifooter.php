...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container" data-aos="zoom-in-down" data-aos-delay="1000"><br>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-4 book1" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-md-4 book1" data-aos="fade-up" data-aos-delay="500">
                <img src="img/book.png" width="30%;" alt="" style="">
    ...
    <br><br>
    <div class="jumbotron jumbotron-fluid parallax" data-aos="zoom-in" data-aos-delay="200">
        <div class="container" >
        ...
        <div class="row justify-content-center ">
            <div class="col-md-12 infoku">
                <div class="row text-center justify-content-center">
                    <div class="col-md font1" data-aos="zoom-in-down"  data-aos-delay="400">>
                        <img src="img/font1.png" width="30%;" alt="font1" style="">
                        <h4>Hadir Tahun 2020</h4>
                        <p>Dengan Sistem Keren</p>
                    </div>
                    <div class="col-md font1" data-aos="zoom-in-down" data-aos-delay="600">
                        <img src="img/font2.png" width="30%;" alt="font2">
                        <h4>Sistem Konsultasi</h4>
                        <p>Membantu User </p>
                    </div>
                    <div class="col-md font1" data-aos="zoom-in-down"  data-aos-delay="800">>
                        <img src="img/font4.png" width="30%;" alt="font4">
                        <h4>Informasi</h4>
                        <p>PTN & PTS</p>
                    </div>
                    <div class="col-md font1" data-aos="zoom-in-down"  data-aos-delay="900">>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-md-6" data-aos="fade-right" data-aos-delay="700">
                <img src="img/leeruby.jpg" class="img-fluid rubys">
            </div>
            <div class="col-md-6 direktur2" data-aos="fade-left" data-aos-delay="700">
