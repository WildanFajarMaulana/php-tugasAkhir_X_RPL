...
include "koneksi.php";
  ...
  if (isset($_POST["konfirmasi"])) {
    if (tambahinformasi($_POST,$id,$nama,$profesi,$fotoprofil)>0) {
...
<head>
    ...
    <title>TAMBAH INFORMASI PTN</title>
</head>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container" data-aos="zoom-in-down" data-aos-duration="1000"><br><br>
            <h3 class="h3info">ADD INFORMASI PTN</h3>
            <hr class="hrbaru">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <center>
                        <section>
                            ...
                            <input type="file" name="fotouniversitas" placeholder="fotouniversitas" required="">
