...
$queryPTS = query1("SELECT * FROM tb_tambahinformasipts WHERE id='$id'");
        ...
        <div class="row">
            <div class="col">
                <div class="kotak">
                    ...
                    <center> <div class="rounded-circle foto" style="background-image: url('img/<?php echo $data['fotoprofil']  ?>');"></div> </center>
                    <div class="data">
                    ...
                    <center><a href="editprofil.php"><button type="button" class="btn btn-warnings">Edit Profil</button></a></center>
                </div>
            </div>
            <div class="col">
                <div class="kotak2">
        ...
        <div class="row">
            <div class="kotak3">
                   ...
                   <?php foreach ($queryPTN as $ptn ) : ?>
                           ...
                           <div class="dropdown" >
                                ...
                                <div class="dropdown-content">
                                    <a href="editinformasi.php?id= <?php echo $ptn['id'];?> &id_informasi=<?php echo $ptn['id_informasi']; ?>" class="link-drop">Edit Informasi</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="hapusinformasi.php?id=<?php echo $ptn['id'];?>&id_informasi=<?php echo $ptn['id_informasi'];?> " class="link-drop"
                ...
                <?php endforeach; ?>
                            ...
                            <?php }elseif(@$_GET['page']=='datapts'){ ?>
                            <div class="row  mt-4"> 
                   <?php foreach ($queryPTS as $pts ) : ?>
                            <div class=" kotak1">
                     
                              <img src="img/<?php echo $pts['fotoprofil']; ?>" class="rounded-circle  fotopenulis">
                           <div class="dropdown">
                                <i class="fas fa-ellipsis-h"></i>
                                <div class="dropdown-content">
                                    <a href="editinformasipts.php?id= <?php echo $pts['id'];?> &id_ptn=<?php echo $pts['id_informasi']; ?>" class="link-drop">Edit Informasi</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="hapusinformasipts.php?id=<?php echo $pts['id'];?>&id_informasi=<?php echo $pts['id_informasi'];?> " class="link-drop"
                                    onclick="return confirm('Anda Yakin Ingin Menghapusnya?');"
                                    >Hapus Informasi</a>
                                </div>
                            </div>
                            <h5 class="hloginpenulis">&nbsp;&nbsp;&nbsp;<?php echo $pts['nama']; ?></h5>
                            <p class="ppenulis">&nbsp;&nbsp;&nbsp;<?php echo  $pts['profesi']; ?></p>
                             <div class="img-fluid bgfoto" style="background-image: url('img/<?php echo $pts['fotouniversitas']; ?>');">
                                </div>
                            <i class="fas fa-university"></i><p class="puniv"><?php echo $pts['namauniversitas']; ?></p>
                            <a href="isiinformasi.php?id_informasi=<?php echo $pts['id_informasi'];?>" class="btn btn-warning"> Lihat</a>
                            </div>
                <?php endforeach; ?>
            </div>
                            <?php } ?>
