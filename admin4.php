...
if ($_SESSION['level']=='user') {
  header("Location:index.php");
     ...
     $no=1;
     $datakontak=query("SELECT * FROM tb_kontak");
     if (isset($_POST["cari"])) {
     $datakontak= caridatakontak($_POST["keyword"]);
      }
      ...
      <div class="row">
        ...
        <div class="kotak3">
          ...
          <form action="" method="POST" >
                    <input type="text" name="keyword" placeholder="CARI SARAN"  autocomplete="off" >
          ...
          <table class="table table-bordered" width="200px">
            <thead>
              <tr>
                ...
                <th scope="col" class="saran">Saran</th>
             ...
             <?php  foreach ($datakontak as $kontak ) : ?>
              <tr>
                ...
                <td class="email"><?php echo $kontak['email']; ?></td>
                <td ><?php echo $kontak['subject']; ?></td>
                <td class="isi-saran"  style=""><?php echo $kontak['saran']; ?></td>
                <td><a href="deleteadminkontak.php?id=<?php echo $kontak['id'] ?>" class="btn btn-danger" onclick= "return confirm('anda yakin min?')">delete</a></td>
              </tr>
            <?php endforeach; ?>
            </table>
        </div>
