...
if ($_SESSION['level']=='user') {
  header("Location:index.php");
    ...
    $no=1;   
     $datakomentar=query("SELECT * FROM tb_komentar");
     if (isset($_POST["cari"])) {
     $datakomentar= caridatakomentarpts($_POST["keyword"]);
      }
            ...
            <thead>
             ...
             <?php  foreach ($datakomentar as $komentar ) : ?>
              <tr>
                ...
                <td><a href="deletekomentarpts.php?id_komentar=<?php echo $komentar["id_komentar"] ?>" class="btn btn-danger" onclick= "return confirm('anda yakin min?')">delete</a></td>
              </tr>
            <?php endforeach; ?>
            </table>
        </div>
