...
@$id=$_SESSION["id"];
 $query=query("SELECT * FROM tb_tambahinformasipts ORDER BY id ASC");
 // tombol cari di klik
 if (isset($_POST["cari"])) {
     $query = caripts($_POST["keyword"]);
 }
 ?>
<!doctype html>
<html lang="en">
        ...
        <div class="row justify-content-center">
            <?php 
             if (!isset($_SESSION["level"])) {
                ...
                <a href='tambahinformasipts.php'><button type='button' class='btn oldwarning '>Upload Informasi</button></a>
            ...
            <div class="col-md-3 kotak1">
                    ...
                    <?php   if (!isset($_SESSION["level"])) { ?>
                           ...
                           <a href="isiinformasipts.php?id_informasi=<?php echo $informasi['id_informasi'];?>" class="btn btn-warning"> Lihat</a>
                    <?php   } else { ?>
                           ...
                           <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="editinformasipts.php?id= <?php echo $informasi['id'];?> &id_informasi=<?php echo $informasi['id_informasi']; ?>" class="link-drop">Edit Informasi</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="hapusinformasipts.php?id=<?php echo $informasi['id'];?>&id_informasi=<?php echo $informasi['id_informasi'];?> " class="link-drop"
